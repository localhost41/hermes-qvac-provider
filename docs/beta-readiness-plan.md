...
| Linux x64 | Packed install, real Hermes discovery, authenticated external QVAC inference, tool outcome, and cleanup pass on a fresh Linux x64 host | Platform | Mandatory packed real-Hermes transport/cleanup lane added; physical QVAC inference and tool outcome still require a model-capable runner |
