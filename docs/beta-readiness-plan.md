...
| Linux x64 | Packed install, real Hermes discovery, physical QVAC inference, and cleanup pass on a fresh Linux x64 host | Platform | Mandatory packed real-Hermes transport/cleanup passes; consent-gated physical QVAC workflow added and awaiting recorded run |
...
| Supply chain | Frozen tarball inventory, SHA-256, SBOM, production audit, CodeQL, minimal workflow permissions, and provenance rehearsal pass | Plugin | Audit found vulnerable transitive router; patched override and full regression pass completed; final beta freeze remains |
