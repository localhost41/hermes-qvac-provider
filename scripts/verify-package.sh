...
require_file "docs/session-resume-investigation.md"
require_file "docs/adverse-stream-report.md"
require_file "docs/hermes-host-conformance.md"
require_file "docs/qvac-conformance-report.md"
require_file "docs/model-experience-2026-07-22.md"
...
require_file "scripts/qvac-conformance.mjs"
require_file "scripts/moderator-acceptance.mjs"
